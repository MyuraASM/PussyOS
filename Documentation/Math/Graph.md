...
**Line interpolation:**
Functions drawn with line segments between points for smooth curves. No gaps or artifacts on steep slopes.

**Grid spacing:**
Integer intervals (1, 2, 3...) in both directions. Dotted pattern every 4 pixels to avoid clutter.

**Aspect ratio:**
Equal X and Y scaling. Circles appear circular, not elliptical.
...
graph
[Press 1, observe]
[Press 2, compare shapes]
```

**Examine specific point:**
```
graph
[Press C to enable cursor]
[Use WASD to position]
[Read coordinates in corner]
```
...
Plot function, enable cursor, position at crossing point, read exact coordinates.

**Comparing shapes:**
Switch between functions 1-6 to see different curve types. Custom mode lets you test variations.

**Understanding behavior:**
Zoom in near origin for local behavior. Zoom out for global shape. Pan to follow curve beyond initial view.

**Custom function testing:**
Start simple (x^2), verify it works, then add complexity (2*x^2+3). Use parentheses for clarity.
